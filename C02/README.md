# C02 Exercise: Python Operators, Conditionals, and Loops
This exercise is designed to help you practice using Python fundamentals: operators, conditionals, and loops.
...
## What do I do?
Read the *[Getting Started](../C00/README.md)* document to learn how these challenges work.

Start by reading the **lesson 2** study material provided by your instructor.
...
- **[`exercise_test.py`](exercise_test.py)**:
...
## Tips for Success
- **Do not modify [`exercise_test.py`](exercise_test.py) or change function definitions in [`exercise.py`](exercise.py).**
